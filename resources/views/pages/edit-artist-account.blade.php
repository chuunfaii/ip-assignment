        ...
        <form action="{{ route('edit-account') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-group justify-content-between">
                <div class="form-floating mb-4" style="min-width:230px;">
                    <input type="text" id="txtFName" class="form-control @error('first_name') error-input @enderror" placeholder="John"
                     value="{{ auth()->user()->first_name }}" name="first_name"/>
                    <label for="txtFName">First Name</label>
                </div>
                <div class="form-floating mb-4" style="min-width:230px;">
                    <input type="text" id="txtLName" class="form-control @error('last_name') error-input @enderror" placeholder="Doe"
            ...
            <div class="form-floating mb-4">
                <input type="email" id="txtEmail" class="form-control @error('email') error-input @enderror" placeholder="name@example.com"
            ...
            <div class="form-floating mb-4">
                <input type="password" id="txtCurrPassword" class="form-control @error('password') error-input @enderror"
            ...
            <div class="form-floating mb-4">
                <input type="password" id="txtConfirmNewPass" class="form-control @error('new_password') error-input @enderror"
                    placeholder="Enter new passowrd again" name="new_password_confirmation"/>
            ...
            <div class="d-grid gap-2 d-md-block">
                ...
                <button type="submit" id="btnSave" class="btn btn-primary py-3 float-end px-5"
