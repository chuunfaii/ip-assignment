...
?>
<link rel="stylesheet" href="css/EditArtistAccount.css">

<main class="mx-auto my-5" style="min-width: 500px;">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="button" id="btnConfirm" class="btn btn-primary px-4" onclick="btnConfirm_Click">Confirm</button>
                        </div>
                    </div>
                </div>
            </div>
